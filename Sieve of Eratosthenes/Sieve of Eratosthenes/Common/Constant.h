...
#define AppName  @"Sieve of Eratosthenes"
#define NAVCOLOR RGB(48, 63, 159)
#define STR_OK   @"OK"
...
#define NOT_VISITED_COLOR   @"000000"
#define PRIME_COLOR         @"ff6b00"
#define COMPOSITE_COLOR     @"64b5f6"
...
#define kProximaNovaThin        @"ProximaNova-Thin"
...
#define SHOW_ALERT(TITLE, MSG) [[[UIAlertView alloc] initWithTitle:(TITLE) \ message:(MSG) \ delegate:nil \ cancelButtonTitle:STR_OK \
